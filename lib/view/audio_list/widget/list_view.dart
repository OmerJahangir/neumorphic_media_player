...
import 'package:media_player/model/audio_file_model.dart';
import 'package:media_player/view/player/player_page.dart';
...
class ListViewFiles extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => controller.audioFiles.isEmpty
        ...
        : const Expanded(child: AnimatedFileList()));
  }
}
        ...
        return SlideTransition(
            ...
            child: GestureDetector(
              ...
              () => Container(
                  ...
                  color: controller.playedIndex.value == index
                        ...
                        () => GestureDetector(
                          ...
                          child: Hero(
                            ...
                            child: CircularSoftButton(
                              lightColor: controller.playedIndex.value == index
                                  ? Colors.white38
                                  : Colors.white38,
                            ...
                            Obx(
                              () => Text(
                                controller.audioLength.isNotEmpty &&
                                        index < controller.audioLength.length
