...
import 'package:media_player/view/audio_list/widget/bottom_player.dart';
import 'package:media_player/view/audio_list/widget/list_view.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          Positioned.fill(
            child: Column(
              children: [const CustomAppBar(), ListViewFiles()],
            ),
          ),
          Positioned(
              bottom: 1,
              left: 1,
              right: 1,
              child: Obx(() => bottomController.isPlaying.value
                  ? const BottomPlayer()
                  : Container(
                      height: 1,
                      color: Colors.orange,
